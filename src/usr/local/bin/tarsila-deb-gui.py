...
Nativo do Tarsila OS. Se a Tarsila Store estiver instalada, o backend
(tarsila-deb-instalar) delega a criação de atalhos curados ao
tarsila-atalho-criar; se não, apenas instala o pacote.
"""
import gi
...
INSTALLER = "/usr/local/bin/tarsila-deb-instalar"
